...
if("TRUE" STREQUAL "TRUE")
  set(slam_sim_demo_SOURCE_PREFIX /home/zk/zk/obstacle_avoidance/clean_avoidance/src/slam_sim_demo)
  set(slam_sim_demo_DEVEL_PREFIX /home/zk/zk/obstacle_avoidance/clean_avoidance/devel)
  ...
  set(slam_sim_demo_INSTALL_PREFIX /home/zk/zk/obstacle_avoidance/clean_avoidance/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'slam_sim_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zk/zk/obstacle_avoidance/clean_avoidance/src/slam_sim_demo/${idir}'.  ${_report}")
    endif()
