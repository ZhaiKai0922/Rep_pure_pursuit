...
if("TRUE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /home/zk/zk/obstacle_avoidance/clean_avoidance/src/costmap_2d)
  set(costmap_2d_DEVEL_PREFIX /home/zk/zk/obstacle_avoidance/clean_avoidance/devel)
  ...
  set(costmap_2d_INSTALL_PREFIX /home/zk/zk/obstacle_avoidance/clean_avoidance/install)
...
if(NOT "/home/zk/zk/obstacle_avoidance/clean_avoidance/devel/include;/home/zk/zk/obstacle_avoidance/clean_avoidance/src/costmap_2d/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(costmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/zk/zk/obstacle_avoidance/clean_avoidance/devel/include;/home/zk/zk/obstacle_avoidance/clean_avoidance/src/costmap_2d/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zk/zk/obstacle_avoidance/clean_avoidance/src/costmap_2d/${idir}'.  ${_report}")
    endif()
